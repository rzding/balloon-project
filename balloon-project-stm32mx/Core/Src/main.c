...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, Cam_CS_Pin|Temp_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : IMU_CS_Pin LoRa_CS_Pin BARO_CS_Pin microSD_CS_Pin */
  GPIO_InitStruct.Pin = IMU_CS_Pin|LoRa_CS_Pin|BARO_CS_Pin|microSD_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /*Configure GPIO pin : microSD_detect_Pin */
