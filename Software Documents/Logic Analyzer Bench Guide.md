...
| DRA818V APRS | USART2 + TIM2 PWM | F10.1 AT @ 9600; F10.2 AFSK on PA0; PTT/PD idle high |
...
- **APRS USART2 / PTT / PWM:** F10.1 boot AT on USART2 @ 9600; F10.2 TIM2 CH1 (PA0) Bell 202 AFSK via `aprs_afsk_set_tone` / `play_bits`. PD high, PTT high (RX idle) — no PTT TX until F10.3.
